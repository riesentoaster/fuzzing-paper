...
\begin{multicols}{2}
    ...
    \citeauthor{HackArtScience} gives an easy-to-read introduction to fuzzing in this work. They discuss blackbox, grammar-based, whitebox, greybox, and hybrid fuzzing and provide code examples that show how some of these approaches work. SAGE\cite{SAGE} is discussed comparatively extensively, KLEE\cite{KLEE}, S2E\cite{S2E}, and SPF\cite{SPF} are mentioned.
