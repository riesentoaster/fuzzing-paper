...
\begin{multicols}{2}
    ...
    \paragraph{All You Ever Wanted to Know about Dynamic Taint Analysis and Forward Symbolic Execution (but Might Have Been Afraid to Ask) (\citedate{AllYouEverWanted})}
    ...
    \paragraph{Symbolic Execution for Software Testing in Practice – Preliminary Assessment (\citedate{PreliminaryAssessment})}
    ...
    \paragraph{Symbolic Execution for Software Testing: Three Decades Later (\citedate{ReviewThreeDecades})}
    ...
    \paragraph{Evaluating Fuzz Testing (\citedate{ReviewThreeDecades})}
    ...
    \paragraph{Fuzzing: a survey (\citedate{FuzzingASurvey})}
    ...
    \paragraph{The Art, Science, and Engineering of Fuzzing: A Survey (\citedate{ArtScienceEng})}
    ...
    \paragraph{Demystify the Fuzzing Methods: A Comprehensive Survey (\citedate{Demystifying})}
