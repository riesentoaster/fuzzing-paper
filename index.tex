...
\begin{multicols}{2}
    ...
    \begin{itemize}
        ...
        \item Caching function summaries for later use by higher-level functions. Example: SMART\cite{SMART}, HOTG\cite{HigherOrderTestGeneration}
